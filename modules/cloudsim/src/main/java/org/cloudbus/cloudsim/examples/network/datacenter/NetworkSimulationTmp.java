 ...
 */
public class NetworkSimulationTmp extends AppCloudlet {

    /**
     * The class for printing out the logs
     */
    private static final Logger LOGGER = Logger.getLogger(NetworkSimulationTmp.class);
     ...
     */
    public NetworkSimulationTmp(int type, int appID, double deadline, int userId) {
    ...
    private static NetworkDatacenter createDatacenter(String name) {
        ...
        int bw = 1000000; // Updated by xiaoleiy: incresed bandwidth from 10000 to 1000000
        for (int i = 0; i < NetworkConstants.EdgeSwitchPort * NetworkConstants.AggSwitchPort
                * NetworkConstants.RootSwitchPort; i++) {
            // 2. A Machine contains one or more PEs or CPUs/Cores.
            // In this example, it will have only one core.
            // 3. Create PEs and add these into an object of PowerPeList.
            // Updated by xiaoleiy: increse size of PE from 8 to 32;
            List<Pe> peList = new ArrayList<Pe>();
